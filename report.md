...
- **Vue.js:** Es un framework de JavaScript de código abierto utilizado para construir interfaces de usuario interactivas y aplicaciones de una sola página (SPA). Fue creado por Evan You y se ha convertido en una herramienta popular en el mundo del desarrollo web.

![](https://media.discordapp.net/attachments/1150112902737580138/1157715283285377206/102.jpeg?ex=65199de0&is=65184c60&hm=43844f00ac18236ceb06697a2b1c2e8125e1c2dbbe5a6774918ebf8836bcb2cb&=)
...
|Attendees (to planning meeting|Lucía Aliaga Trevejo/Max Anthony Paitan Pumacahua/Trujillo Lopez, Luis Alberto/Luis Alberto Siancas Reategui/Ramos Vicente, William|
...
|**Attendees (to planning meeting)**|<p></p><p>Aliaga Trevejo, Lucía Guadalupe / Paitán Pumacahua, Max Anthony / Ramos Vicente, William / Siancas Reategui, Luis Alberto / Trujillo Lopez, Luis Alberto</p><p> </p>|
...
|US 062|Información de la Startup |S03|Implementación de la sección de nuestros servicios del Landing Page|Desarrollo de la sección de nuestros servicios en html y css|3 hours|Lucia Aliaga|Done|
...
<tr><td colspan="1" rowspan="4" valign="top">US026</td><td colspan="1" rowspan="4" valign="top">Publicar recetas</td><td colspan="1" valign="top">T001</td><td colspan="1" valign="top">Implementar la barra de navegación principal</td><td colspan="1" valign="top">El desarrollador implementa la barra de navegación usando Vue. </td><td colspan="1" valign="top">2 horas</td><td colspan="1" valign="top">Lucía Aliaga</td><td colspan="1" valign="top">Done</td></tr>
<tr><td colspan="1" valign="top">T002</td><td colspan="1" valign="top">Implementar la vista home del cocinero</td><td colspan="1" valign="top">El desarrollador crea el componente para la vista Home del cocinero e implementa la lógica para mostrar las recetas creadas</td><td colspan="1" valign="top">3 Horas</td><td colspan="1" valign="top">Lucía Aliaga</td><td colspan="1" valign="top">Done</td></tr>
<tr><td colspan="1" valign="top">T003</td><td colspan="1" valign="top">Implementar el componente para agregar receta </td><td colspan="1" valign="top">El desarrollador implementa los componentes y lógica para añadir recetas.</td><td colspan="1" valign="top">3 Horas</td><td colspan="1" valign="top">Lucía Aliaga</td><td colspan="1" valign="top">Done</td></tr>
<tr><td colspan="1" valign="top">T004</td><td colspan="1" valign="top">Realizar una limpieza de código</td><td colspan="1" valign="top">Corrección de errores y optimización de código </td><td colspan="1" valign="top">1 Hora</td><td colspan="1" valign="top">Lucía Aliaga</td><td colspan="1" valign="top">Done</td></tr>
<tr><td colspan="1" rowspan="2" valign="top">US028</td><td colspan="1" rowspan="2" valign="top">Editar recetas</td><td colspan="1" valign="top">T001</td><td colspan="1" valign="top">Implementar el componente para editar receta </td><td colspan="1" valign="top">El desarrollador implementa los componentes y lógica para editar las recetas creadas.</td><td colspan="1" valign="top">2 Horas</td><td colspan="1" valign="top">Lucía Aliaga</td><td colspan="1" valign="top">Done</td></tr>
...
|**Repository**|**Branch**|**Commit ID**|**Commit Message**|**Commit Message Body**|**Commited on date**|
| :-: | :-: | :-: | :-: | :-: | :-: |
|Cook-guide-vue|development|ac701a6b904518f6ee52ec8be2e064bd05a67721|feat: added styles|feat: added styles|29/09/2023|
|Cook-guide-vue|development|90c5e324eb025b18ff815978aef2dc74331baabe|feature: add edit-recipe-card component|feature: add edit-recipe-card component|29/09/2023|
|Cook-guide-vue|development|521531882aeb1602eee49235076dd1e5b9567155|feat: added edit-recipe functionality|feat: added edit-recipe functionality|29/09/2023|
|Cook-guide-vue|development|5761ce6e2c194cf9c397e6c487b700e4a77a5fac|feat: retrieve user id from localstorage|feat: retrieve user id from localstorage|29/09/2023|
|Cook-guide-vue|development|e7e7bc4e02ce7ba5999facc5b1cd94e35cce268c|fix: add/edit|fix: add/edit|29/09/2023|
